...
public class ModuloBoleo implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		listBoletoBoletoTracking.addAll(Arrays.asList(boletoTracking1, boletoTracking2, boletoTracking3, boletoTracking4, boletoTracking5, boletoTracking6, boletoTracking7, boletoTracking8));
	...
	public static void main(String[] args) {
		SpringApplication.run(ModuloBoleo.class, args);
	}
